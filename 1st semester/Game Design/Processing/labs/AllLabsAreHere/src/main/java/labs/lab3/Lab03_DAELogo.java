...
/**
 * DAE Logo
 * An image is loaded and shown multiple times on the sketch. A part of the image
 * is copied and drawn using image dimension math.
 */
public class Lab03_DAELogo extends PApplet {

 ...
 * Lab_01_Draw_01
 * ==============  Task  ==============
 * Use a light-colored background. Draw the six elements following the guidelines
 * below. Keep your code readable and start each part with an appropriate
 * comment line.
 * 1. Paint a red filled house.
 * 2. Paint a black outlined house
 * 3. Paint a yellow quad with black stroke
 * 4. Draw a flag containing 3 equal vertical bands of different colors and a black flagpole.
 * 5. Paint a 3 by 3 white/black game board
 * 6. Paint 3 ellipses
 *
 * @author dcuciuc
 */
public class Lab_01_Draw_01 extends PApplet {
